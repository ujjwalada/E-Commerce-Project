...
<footer className="footer p-10 bg-base-200 text-base-content">
  <aside>
    <h2 className='text-3xl'>CourseCart</h2>
    <p>Providing High Quality Courses and Templates since 2024</p>
  </aside> 
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">customercare@CourseCart</a>
    <a className="link link-hover">+91 9332211889</a>
  </nav> 
